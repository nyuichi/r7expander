...
RUN_COMPILED = $(GOSH) -u scheme.base -u srfi.1 --
OPTS = -l ./r7expander/syntactic-closure.sld -l ./r7expander/library.sld main.scm

r7expander.scm: r7expander/syntactic-closure.sld r7expander/library.sld init.scm pp.scm main.scm
